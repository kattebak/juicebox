...
export async function promptCallbackUrl({ path, expectParam }) {
  ...
  try {
    process.stderr.write(
      `\nfrom the paste-helper page on kattebak.github.io, copy the ${expectParam} value\n` +
        `(the page also auto-copies it to your clipboard) and paste below — or paste the\n` +
        `full URL from your browser's address bar if you'd rather.\n\n`,
    );
